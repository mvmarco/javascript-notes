...
*/
// EXAMPLE 1
// similar to moment.js but shorter, take what you want
const diff = (0, _dateFns.formatDistance)(new Date(1986, 3, 4, 11, 32, 0), new Date(1986, 3, 4, 10, 32, 0), {
  addSuffix: true
}); //= > 'in about 1 hour'

console.log(diff); // EXAMPLE 2

const diff2 = (0, _dateFns.formatDistance)(new Date(), new Date(2021, 3, 4, 10, 32, 0), {
  addSuffix: true
}); //= > 'in about 1 month'

console.log(diff2); // EXAMPLE 3
...
const formatted = (0, _dateFns.format)(date, `LLLL 'the' do y`); // check the doc for this
